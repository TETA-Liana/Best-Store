const Loginas=()=>{
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-white relative">
          <div className="absolute inset-0 bg-[#3b3b98] clip-path-custom"></div>
          <div className="relative z-10 text-center text-white p-8 rounded-lg">
            ...
            <button className="block w-48 mx-auto my-2 py-2 bg-gray-300 text-black rounded">login</button>
